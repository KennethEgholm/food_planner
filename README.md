...
TOKEN_ENCRYPTION_KEY=<random-32-bytes>       # Encrypts stored Google tokens (openssl rand -hex 32)
```
...
| `TOKEN_ENCRYPTION_KEY` | Random secret encrypting stored Google tokens (`openssl rand -hex 32`) |
